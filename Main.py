...
agent1 = DefaultMiniMaxAgent(1, 0.01)
agent2 = DefaultMiniMaxAgent(2, 0.01)
#call env();
#inputs are board size, win condition, agent1, agent2, and batch size
env=Env(3,3,agent1,agent2,20,epsilon=0, agent1_is_training = True, agent2_is_training = True)
#play batches
